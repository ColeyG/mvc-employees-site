...
@section('content')
  ...
  <section class="employee">
    ...
    <p>{{ $employee->code }}</p>
    <p>This employee is a joy to work with! They quickly updated my application, answered my questions and came up with an implementation that worked for me. Looking forward to working with them again.
      <br><br>
